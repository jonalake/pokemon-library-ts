...
fetch(`https://pokeapi.co/api/v2/pokemon/${queryString.get("pokemon")}`).then((response)=>response.json()
    ...
    const name = `${lodash_1.default.capitalize(pokemon1.name)}`;
    const title = document.querySelector("title");
    if (title) title.textContent = name;
    main === null || main === void 0 || main.append((0, functions_1.createPokemonDetails)(pokemon1, name));
    const abilitiesRequests = pokemon1.abilities.map((pokemon)=>pokemon.ability.url
    ).map((url1)=>{
    ...
    main === null || main === void 0 || main.append(ul);
    ...
    spinner === null || spinner === void 0 || spinner.classList.add("hidden");
});

},{"lodash":"3qBDj","./functions":"4GXeo"}],"3qBDj":[function(require,module,exports) {
...
},{}],"4GXeo":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}]},["j7ma3","ftD73"], "ftD73", "parcelRequire80db")
